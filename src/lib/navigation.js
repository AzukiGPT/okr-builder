...
export const SECTIONS = [
  { id: "company", label: "Company", icon: "Building2" },
  {
    ...
    subPages: [
      ...
      { id: "context", label: "Context", step: 0, requiresSet: true },
      { id: "objectives", label: "Objectives", step: 1, requiresSet: true },
      { id: "funnel", label: "Funnel", step: 2, requiresSet: true },
      { id: "system", label: "System", step: 3, requiresSet: true },
    ],
  },
